...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.getIncome) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named getIncome');
    }
    this.witnesses = witnesses_0;
    this.circuits = {
      checkEligibility: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`checkEligibility: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const threshold_0 = args_1[1];
        const program_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkEligibility',
                                     'argument 1 (as invoked from Typescript)',
                                     'scholarship-eligibility.compact line 9 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(threshold_0).concat(_descriptor_2.toValue(program_0)),
  ...
  _getIncome_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.getIncome(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 4294967295n)) {
      __compactRuntime.typeError('getIncome',
                                 'return value',
                                 'scholarship-eligibility.compact line 7 char 1',
                                 'Uint<0..4294967296>',
                                 result_0)
    }
  ...
  _checkEligibility_0(context, partialProofData, threshold_0, program_0) {
    const income_0 = this._getIncome_0(context, partialProofData);
    const qualifies_0 = income_0 <= threshold_0;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(0n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(qualifies_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(1n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(program_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
...
const _dummyContract = new Contract({ getIncome: (...args) => undefined });
